...
const eventFixture=readFileSync(new URL('../fixtures/fictional_station_events.geojson',import.meta.url),'utf8');
...
test('published events show BODIK sources and date ranges without invented times',async({page})=>{
 ...
 await page.screenshot({path:'test-results/bodik-event.png',fullPage:true});
});
